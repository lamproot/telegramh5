    ...
    class Ping extends Base {
        public function command ($command, $param, $message_id, $from, $chat, $date) {
            ...
            if ($command == '/女朋友') {
                ...
                $this->telegram->sendMessage ($chat['id'], $copyright, $message_id);
                //$document = "Here you can see a https://www.youtube.com/watch?v=I51S0BRmMOg nd our official animated LoMoStar vide https://www.youtube.com/watch?v=k3SBw97F-ng";
                //$this->telegram->sendDocument ($chat['id'], "http://a4caf36c.ngrok.io/Uploads/file/command_file/5a968f2b28fcd.pdf", $copyright, $message_id);
            ...
            if ($command == '/delete') {
                ...
                //$document = "Here you can see a https://www.youtube.com/watch?v=I51S0BRmMOg nd our official animated LoMoStar vide https://www.youtube.com/watch?v=k3SBw97F-ng";
                //$this->telegram->kickChatMember ($chat['id'], $from['id']);
