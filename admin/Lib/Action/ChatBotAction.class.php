	    ...
	    public function add()
	    {
	    	...
	    	if ($form_key == 'yes')
	    	{
	    		...
	    		if ($chat_bot_add)
	    		{
					...
					$param = ["url" => "https://m.name-technology.fun/callback.php/Callback/runs?bot_id=".$my_add['id']."&t=".time()];
	    ...
	    public function edit()
	    {
	    	...
	    	if ($form_key == 'yes')
	    	{
	    		...
	    		if ($chat_bot_save)
	    		{
					//初始化回调
					$url = 'https://api.telegram.org/bot' . $data['token'] . '/setWebhook';
					$param = ["url" => "https://m.name-technology.fun/callback.php/Callback/runs?bot_id=".$id."&t=".time()];
